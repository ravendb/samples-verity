...
var seeder = builder.AddProject<RavenDB_Samples_Verity_Setup>("seeder")
    ...
    .WithEnvironment("SAMPLES_VERITY_SINK_CERT_PUBLIC_BASE64", sinkCertPublicBase64)
    .WithEnvironment("SAMPLES_VERITY_SINK_CERT_PFX_BASE64", sinkCertPfxBase64)
    ...
    // Aspire RavenDB client integration reads CertificatePath from this config section
    .WithEnvironment("Aspire__RavenDB__Client__CertificatePath", serverCertPath);
